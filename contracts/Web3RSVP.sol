...
bytes32 eventId = keccak256(
    ...
    //Emit the NewEventCreated event to expose those informations to the subgraph
    ...
    //Emit the NewRSVP event to expose those informations to the subgraph
...
function confirmAttendee(bytes32 eventId, address attendee) public {
    ...
    //Emit the COnfirmedAttendee event to expose those informations to the subgraph
    ...
    function withdrawUnclaimedDeposits (bytes32 eventId) external{
       ...
       //Emit the DepositsPaidOut event to expose those informations to be read by the subgraph
